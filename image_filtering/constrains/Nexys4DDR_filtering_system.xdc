...
set_property -dict {PACKAGE_PIN R12 IOSTANDARD LVCMOS33} [get_ports config_finished]
...
##Pmod Header JA <= 3V3-RESET

set_property -dict {PACKAGE_PIN C17 IOSTANDARD LVCMOS33} [get_ports {ov7670_data[7]}]
set_property -dict {PACKAGE_PIN D18 IOSTANDARD LVCMOS33} [get_ports ov7670_pclk]
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets ov7670_pclk_IBUF]
set_property -dict {PACKAGE_PIN E18 IOSTANDARD LVCMOS33} [get_ports ov7670_vsync]
set_property -dict {PACKAGE_PIN G17 IOSTANDARD LVCMOS33} [get_ports ov7670_sioc]
...
set_property -dict {PACKAGE_PIN E16 IOSTANDARD LVCMOS33} [get_ports ov7670_pwdn]
set_property -dict {PACKAGE_PIN F13 IOSTANDARD LVCMOS33} [get_ports {ov7670_data[0]}]
set_property -dict {PACKAGE_PIN G13 IOSTANDARD LVCMOS33} [get_ports {ov7670_data[2]}]
set_property -dict {PACKAGE_PIN H16 IOSTANDARD LVCMOS33} [get_ports {ov7670_data[4]}]
...
set_switching_activity -toggle_rate 0.000 -static_probability 0.000 [get_nets inst_ov7670_control/Inst_sccb_sender/sioc_i_1_n_0]
set_switching_activity -toggle_rate 0.000 -static_probability 0.000 [get_nets {inst_ov7670_control/Inst_sccb_sender/busy_sr[31]_i_1_n_0}]
set_switching_activity -toggle_rate 0.000 -static_probability 0.000 [get_nets {inst_image_refresh/SR[0]}]
set_switching_activity -toggle_rate 0.000 -static_probability 0.000 [get_nets {inst_ov7670_control/Inst_sccb_sender/data_sr[30]_i_1_n_0}]
